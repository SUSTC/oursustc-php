...
class AlipaySubmit {
	...
	function buildRequestForm($para_temp, $method, $button_name) {
		...
		$sHtml = "<form id='alipaysubmit' name='alipaysubmit' class='form-vertical' action='".$this->alipay_gateway_new."_input_charset=".trim(strtolower($this->alipay_config['input_charset']))."' method='".$method."'>";
    ...
    $sHtml = $sHtml
      ...
      ."<input type='submit' class='submit btn btn-primary pull-right' value='".$button_name."'>"
      ."</div></form>";
