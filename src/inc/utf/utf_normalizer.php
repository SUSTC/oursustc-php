...
class utf_normalizer
{
	...
	*/
	public static function cleanup(&$str)
	{
		...
		if (!isset($GLOBALS['utf_nfc_qc']))
		{
			...
			include($phpbb_root_path . 'inc/utf/data/utf_nfc_qc.' . $phpEx);
		}

		if (!isset($GLOBALS['utf_canonical_decomp']))
		{
			global $phpbb_root_path, $phpEx;
			include($phpbb_root_path . 'inc/utf/data/utf_canonical_decomp.' . $phpEx);
		}
	...
	*/
	public static function nfkc(&$str)
	{
		...
		{
			global $phpbb_root_path, $phpEx;
			include($phpbb_root_path . 'inc/utf/data/utf_nfkc_qc.' . $phpEx);
		}

		if (!isset($GLOBALS['utf_compatibility_decomp']))
		{
			global $phpbb_root_path, $phpEx;
			include($phpbb_root_path . 'inc/utf/data/utf_compatibility_decomp.' . $phpEx);
		}
	...
	*/
	public static function recompose($str, $pos, $len, &$qc, &$decomp_map)
	{
		...
		{
			global $phpbb_root_path, $phpEx;
			include($phpbb_root_path . 'inc/utf/data/utf_normalizer_common.' . $phpEx);
		}
		...
		{
			global $phpbb_root_path, $phpEx;
			include($phpbb_root_path . 'inc/utf/data/utf_canonical_comp.' . $phpEx);
		}
